...
| 項目       | 要件                                    | 詳細                                                                                                                                                                                                                               | 留意点                                                             |
| ---------- | --------------------------------------- | ---------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------- | ------------------------------------------------------------------ |
| 環境構築   | README.mdを準備する事                   | 記載する情報については[参照1](#参照1)および[参照2](#参照2)を確認する事<br>必ず管理者ユーザー及び一般ユーザーのログイン情報を準記載する事                                                                                           | READMEにログイン情報の記載がない場合は大きく減点される可能性がある |
|            | 環境構築が可能である事                  | README.mdに記載された方法で環境構築できるか（マイグレーションまでが対象）                                                                                                                                                          | 採点者が環境構築出来ない場合、大きく減点される可能性がある         |
|            | ER図が正常か                            | テーブルの表記やカーディナリティが適正である事                                                                                                                                                                                     |                                                                    |
|            | マイグレーションが適正か                | マイグレーションが実行でき、マイグレーションファイルとテーブル仕様書が一致している事                                                                                                                                               |                                                                    |
|            | ダミーデータが作成可能か                | 下記の情報に対してダミーデータを作成出来る事<br>1.ユーザー情報<br>管理者ユーザーと一般ユーザーのどちらも作成する<br>2. 勤怠記録情報<br>出勤・退勤・休憩時間に関するダミーデータを作成する                                          | ダミーデータが作成出来ない場合は大きく減点される可能性がある       |
